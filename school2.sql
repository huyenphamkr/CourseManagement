...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 06, 2022 lúc 05:18 PM
...
(8, 'Huyen', 12345.6, '2007-09-01 00:00:00', 33),
(9, '王俊凱', 12345.6, '2022-09-01 00:00:00', 21);
...
(32, '203 Williams', '2022-02-23 10:19:22'),
...
(1, 'Abercrombie a', 'Kim', '1995-03-11 00:00:00', NULL),
...
(32, 'XuXu', 'Kristen', '2001-07-23 00:00:00', NULL),
(33, 'Gao', 'Erica', NULL, '2003-01-30 00:00:00'),
(34, 'Van Houten', 'Roger', '2000-12-07 00:00:00', NULL),
(36, 'Seo-joon', 'Park', '2022-05-12 00:00:00', NULL),
(46, 'Hyun', 'Bin', '2020-10-14 00:00:00', NULL);
...
--
ALTER TABLE `course`
  MODIFY `CourseID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4071;
...
--
ALTER TABLE `studentgrade`
  MODIFY `EnrollmentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
